      ...
      <div className="mt-7 w-full space-y-3 divide-y divide-white/10 bg-neutral-darkest px-4 text-white">
        <div className="mx-auto grid max-w-sm gap-8 py-12 md:max-w-7xl md:grid-cols-3">
          ...
          <div className="text-center">
            <h3 className="mb-3 pt-3 text-2xl font-medium text-white">
              Company
            </h3>
        ...
        <div className="mx-auto flex max-w-7xl justify-between px-4 pt-6 pb-2 text-xs sm:text-base">
          ...
          <div className="flex gap-1 sm:gap-5">
            ...
            <img
              src={MasterCard}
              alt="master card"
              className="object-contain sm:w-10"
            />
          </div>
        </div>
      </div>
