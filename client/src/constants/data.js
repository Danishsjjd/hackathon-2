			...
			sections: [
				{
					name: "Baths",
					items: [
						{ name: "View All", to: "/shope" },
						{ name: "Cost iron baths", to: "/shope" },
						{ name: "Copper Baths", to: "/shope" },
						{ name: "Bath Tops & Mixers", to: "/shope" },
						{ name: "Bath wastes", to: "/shope" },
					],
				},
				{
					name: "Showers",
					items: [
						{ name: "View All", to: "/shope" },
						{ name: "freestanding Showers", to: "/shope" },
						{ name: "Showers Sets & Controls", to: "/shope" },
						{ name: "Showers Heads & Arms", to: "/shope" },
						{ name: "Shower Accessories", to: "/shope" },
					],
				},
				{
					...
					items: [
						{ name: "View All", to: "/shope" },
						{ name: "Lightings", to: "/shope" },
						{ name: "Mirrors", to: "/shope" },
						{ name: "Organizers", to: "/shope" },
						{ name: "Living Room Accessories", to: "/shope" },
					],
				},
				{
					...
					items: [
						{ name: "View All", to: "/shope" },
						{ name: "Complete WC Suites", to: "/shope" },
						{ name: "Loo Seats", to: "/shope" },
						{ name: "Bidets & WC Accessories", to: "/shope" },
					],
				},
				{
					name: "Bedroom",
					items: [
						{ name: "View All", to: "/shope" },
						{ name: "Bed Accessories", to: "/shope" },
						{ name: "Curtains", to: "/shope" },
						{ name: "Chets", to: "/shope" },
						{ name: "Mattresses", to: "/shope" },
					],
				},
				{
					name: "More",
					items: [
						{ name: "Kitchen Taps & Lighting", to: "/shope" },
						{ name: "Archive Collection", to: "/shope" },
						{ name: "Ex-Display Collection", to: "/shope" },
					],
				},
			],
		},
...
export const homeCategories = [
	{ Icon: LivingRoom, title: "Apartment" },
	{ Icon: Bedroom, title: "villa" },
	{ Icon: Kitchen, title: "Studio" },
	{ Icon: Bathroom, title: "Townhouse" },
	{ Icon: Workspace, title: "Twin house" },
	{ Icon: Accessories, title: "house" },
];
// home - cards - imgAlt
